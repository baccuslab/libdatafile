...
class H5Recording {
	...
	public:
		 ...
		 *
		 * The data is stored in the Armadillo library's matrix types, which have
		 * been aliased as the "Samples" and "SamplesD" types, for signed short and
		 * double samples, respectively.
		 */
